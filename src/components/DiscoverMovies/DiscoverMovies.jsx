    ...
    return (
        <div>
            <div>
                ...
                <h2 className="text-3xl font-bold">Discover Movies</h2>
                <label className="relative inline-flex items-center cursor-pointer border border-teal-700 rounded-full">
                    ...
                    <div className="w-64 h-7 bg-gray-200 border-red peer-focus:outline-none rounded-full peer dark:bg-white peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-gray-200 after:content-[''] after:absolute after:top-0 after:start-0 after:bg-emerald-700 after:text-white after:border-gray-300 after:border after:rounded-full after:h-[34px] after:w-32 after:transition-all dark:border-emerald-700 ">
                    </div>
